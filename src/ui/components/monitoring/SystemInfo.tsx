// filepath: src/ui/components/monitoring/SystemInfo.tsx
'use client'
interface SystemInfoProps { nodeVersion: string; environment: string; platform: string; uptime: number; memoryUsage: number; previewSecret: boolean }
export function SystemInfo({ nodeVersion, environment, platform, uptime, memoryUsage }: SystemInfoProps) {
  return (
